...
public final class BitConverter 
{
	...
	public static byte[] GetBytes(short[] data) {
	    ...
	    for (int i = 0; i < data.length; i++)
	        System.arraycopy(GetBytes(data[i]), 0, byts, i * 2, 2);
	    return byts;
	}
	...
	public static byte[] GetBytes(int[] data) {
	    ...
	    for (int i = 0; i < data.length; i++)
	        System.arraycopy(GetBytes(data[i]), 0, byts, i * 4, 4);
	    return byts;
	}
	...
	public static byte[] GetBytes(long[] data) {
	    ...
	    for (int i = 0; i < data.length; i++)
	        System.arraycopy(GetBytes(data[i]), 0, byts, i * 8, 8);
	    return byts;
	}
	...
	public static byte[] GetBytes(boolean[] data) {
	    ...
	    // ----------
	    int len = data.length;
	    byte[] lena = GetBytes(len); // int conversion; length array = lena
	...
	public static byte[] GetBytes(String[] data) {
	    ...
	    // ----- arrays:
	    byte[] dLen = GetBytes(data.length); // byte array of data length
	    ...
	    byte[] bsLens = GetBytes(sLens); // byte version of String sLens
